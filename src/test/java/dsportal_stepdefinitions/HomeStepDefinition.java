...
public class HomeStepDefinition {
	...
	@When("The user selects {string} from the drop down after Log in.")
	public void the_user_selects_from_the_drop_down_after_log_in(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@When("The user clicks {string} buttons of {string} on the homepage while Log in")
	public void the_user_clicks_buttons_of_on_the_homepage_while_log_in(String string, String string2) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
