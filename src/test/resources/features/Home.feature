...
Feature: Home page features
  ...
  Scenario: Verify the Home page for an user without Sign in
	...
	@tag26
	Scenario: Verify that user able to land on "Array" page while clicking"Get Started" buttons of "Array" on the home page during Log in
		Given The user is on the Home page
		When The user clicks "Get Started" buttons of "Array" on the homepage while Log in
		Then The user should be redirected to "Array" page
		
	@tag27
	Scenario: Verify that user able to land on "Linked List" page while clicking"Get Started" buttons of "Linked List" on the home page during Log in
		Given The user is on the Home page
		When The user clicks "Get Started" buttons of "Linked List" on the homepage while Log in
		Then The user should be redirected to "Linked List" page
		
	@tag28
	Scenario: Verify that user able to land on "Stack" page while clicking"Get Started" buttons of "Stack" on the home page during Log in
		Given The user is on the Home page
		When The user clicks "Get Started" buttons of "Stack" on the homepage while Log in
		Then The user should be redirected to "Stack" page
		
	@tag29
	Scenario: Verify that user able to land on "Queue" page while clicking"Get Started" buttons of "Queue" on the home page during Log in
		Given The user is on the Home page
		When The user clicks "Get Started" buttons of "Queue" on the homepage while Log in
		Then The user should be redirected to "Queue" page
		
	@tag30
	Scenario: Verify that user able to land on "Tree" page while clicking"Get Started" buttons of "Tree" on the home page during Log in
		Given The user is on the Home page
		When The user clicks "Get Started" buttons of "Tree" on the homepage while Log in
		Then The user should be redirected to "Tree" page
		
	@tag31
	Scenario: Verify that user able to land on "Graph" page while clicking"Get Started" buttons of "Graph" on the home page during Log in
		Given The user is on the Home page
