...
public class DataStructureStepDefinition {
	...
	@When("The user clicks the {string} button in Data Structures - Introduction OR The user select Data Structures - Introduction item from the drop down menu")
	public void the_user_clicks_the_button_in_data_structures_introduction_or_the_user_select_data_structures_introduction_item_from_the_drop_down_menu(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("The user be directed to {string}")
	public void the_user_be_directed_to(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	@Given("The user is in the blank {string} page")
	public void the_user_is_in_the_blank_page(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
